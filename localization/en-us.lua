  ...
  descriptions = {
    Joker = {
      ...
      j_nacho_passimian = {
        name = "Passimian",
        text = {
          "Gains the {C:attention}abilities{} and",
          "{C:attention}edition{} of the next {C:attention}sold{}",
          "or {C:attention}destroyed{} Pokemon Joker",
        }
      },
      j_nacho_wimpod = {
        name = 'Wimpod',
      ...
      j_nacho_galarian_meowth = {
        ...
        text = {
          "{X:poke_metal,C:white}Metal{} Jokers score with",
